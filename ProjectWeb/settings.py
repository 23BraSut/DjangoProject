...
SECRET_KEY = 'django-insecure-@dhzql64=v8%d#115y=^^#l7m12-&+gxa=#vw(m)kakvrf6hha'
...
# Needed due to recurring error of none login acess
LOGIN_URL = '/WebsitePortfolio/login/'
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/WebsitePortfolio/login/'